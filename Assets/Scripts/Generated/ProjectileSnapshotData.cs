...
public struct ProjectileSnapshotData : ISnapshotData<ProjectileSnapshotData>
{
    public uint tick;
    ...
    public void Serialize(int networkId, ref ProjectileSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref ProjectileSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref ProjectileSnapshotData target, float factor)
    {
